...
# step 3: make graphs 
#************************************************************
inpath <- "C:/Users/Aaron_clover/Desktop/HEG_folder/_interview_prep/07_data_scraping/data/"
outpath <- "C:/Users/Aaron_clover/Desktop/HEG_folder/_interview_prep/07_data_scraping/out/"
#*************************************************************
...
#*************************************************************
tiff(paste0(outpath, "sf_home_price.tiff"), width=1500, height=1200)
ggplot() +
...
tiff(paste0(outpath, "sf_home_price_change.tiff"), width=1500, height=1200)
ggplot() +
...
#*************************************************************
tiff(paste0(outpath, "condo_home_price.tiff"), width=1500, height=1200)
ggplot() +
...
#*************************************************************
tiff(paste0(outpath, "condo_home_price_change.tiff"), width=1500, height=1200)
ggplot() +
